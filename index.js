...
auth: state,
browser: ['KeceMods Bot Wa', '', '']
});
if(usePairingCode && !XeonBotInc.authState.creds.registered) {
		const phoneNumber = await question('Baca Asu, Masukan Nomer Yang Aktif Awali Dengan 62:\n');
...
} else if (connection === "open") { XeonBotInc.sendMessage(owner + "@s.whatsapp.net", { text: `*Bot started!*\n\n\n_Don't forget to support, bro :)_\n\nYouTube: https://youtube.com/@randomMek\n\nGitHub: https://github.com/KingKece\n\nInstsgram: https://instagram.com/cemas_ko\n\nWhatsApp Pm: wa.me/6282217841377\n\n ` }); }
